import psycopg2
from src.utils import progress_bar, get_employers, get_vacancies, load_employers_to_db, load_vacancies_to_db, create_tables, add_description_column
...
Ожидайте идет загрузка списка компаний с их id  и количеством вакансий по ним:\n''')
    ...
    try:
        ...
        while action != 0:  # запускаем опросник
            action = input('\n1 - Вывести данные о работадателях на экран\n'
                           '2 - Вывести данные о вакансиях на экран\n'
                           '3 - Вывести писок всех вакансий с указанием названия компании, названия вакансии и '
            ...
            if action == "1":
                ...
                keyword: str = input('Введите слово для фильтрации вакансий\n')
